...
3. Remove inner borders and padding in Firefox.
*/
...
/*
1. Reset the default placeholder color in Firefox. (https://github.com/tailwindlabs/tailwindcss/issues/3300)
...
/* Make sure Tailwind buyers know that Tailwind is not a magic wand and they still have to write code. */
[hidden] {
  display: none;
}
...
.bg-red-900\\/20{
    background-color: rgb(76 29 29 / 0.2)
}
.bg-gradient-to-r{
